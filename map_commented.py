...
# for better results: try following
# maybe try changing temperature parameter
# maybe try changing rewards, e.g. more plus(+) reward for good, and more negative(-) as punishment for stepping on sand etc
# maybe try increasing hidden layer or hidden neurons
